package org.micros.licenses.clients;

import org.micros.licenses.model.Organization;
import org.micros.licenses.repository.OrganizationRedisRepository;
   ...
   /* @Autowired
    ...
    public Organization getOrganization(String organizationId) {
        ...
        ResponseEntity<Organization> restExchange =
                restTemplate.exchange("http://zuulserver:5555/api/organization/v1/organizations/{organizationId}", HttpMethod.GET, null, Organization.class, organizationId);
